...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/sumo` | `npm install @voxgig-sdk/sumo` |
| Python | `voxgig-sdk-sumo` | `pip install voxgig-sdk-sumo` |
| PHP | `voxgig-sdk/sumo` | `composer require voxgig-sdk/sumo` |
| Golang | `github.com/voxgig-sdk/sumo-sdk/go` | `go get github.com/voxgig-sdk/sumo-sdk/go` |
| Ruby | `voxgig-sdk-sumo` | `gem install voxgig-sdk-sumo` |
| Lua | `voxgig-sdk-sumo` | `luarocks install voxgig-sdk-sumo` |
