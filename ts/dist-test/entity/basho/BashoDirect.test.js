...
(0, node_test_1.describe)('BashoDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-basho', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-basho', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["division01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-basho', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-basho', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["basho01", "day01", "division01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SUMO_TEST_BASHO_ENTID'];
...
//# sourceMappingURL=BashoDirect.test.js.map