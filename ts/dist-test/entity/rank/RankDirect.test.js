...
(0, node_test_1.describe)('RankDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-rank', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rank', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SUMO_TEST_RANK_ENTID'];
...
//# sourceMappingURL=RankDirect.test.js.map