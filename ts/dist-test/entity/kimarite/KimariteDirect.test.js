...
(0, node_test_1.describe)('KimariteDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-kimarite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-kimarite', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-kimarite', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-kimarite', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['SUMO_TEST_KIMARITE_ENTID'];
...
//# sourceMappingURL=KimariteDirect.test.js.map