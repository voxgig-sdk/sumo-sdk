...
(0, node_test_1.describe)('RikishiDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rikishi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rikishi', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["opponent01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-rikishi', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-rikishi', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["rikishi01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.SUMO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.SumoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['SUMO_TEST_RIKISHI_ENTID'];
...
//# sourceMappingURL=RikishiDirect.test.js.map