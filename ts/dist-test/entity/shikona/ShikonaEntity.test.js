...
(0, node_test_1.describe)('ShikonaEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/shikona/ShikonaTestData.json');
    ...
    let idmap = transform(['shikona01', 'shikona02', 'shikona03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ShikonaEntity.test.js.map