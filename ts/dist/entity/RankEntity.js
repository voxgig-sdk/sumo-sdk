...
class RankEntity extends SumoEntityBase_1.SumoEntityBase {
    ...
    make() {
        return new RankEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Rank[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
...
//# sourceMappingURL=RankEntity.js.map