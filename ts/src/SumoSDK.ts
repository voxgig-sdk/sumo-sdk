...
class SumoSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('SumoSDK: graphql: ' +
  ...
  Basho(entopts?: Record<string, any>) {
    const self = this
    return new BashoEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Kimarite(entopts?: Record<string, any>) {
    const self = this
    return new KimariteEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Rank(entopts?: Record<string, any>) {
    const self = this
    return new RankEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Rikishi(entopts?: Record<string, any>) {
    const self = this
    return new RikishiEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  Shikona(entopts?: Record<string, any>) {
    const self = this
    return new ShikonaEntity(self, entopts)
  }
