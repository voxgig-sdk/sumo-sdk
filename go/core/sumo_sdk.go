...
func (sdk *SumoSDK) OptionsMap() map[string]any {
...
func (sdk *SumoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *SumoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *SumoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SumoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *SumoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *SumoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("SumoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *SumoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *SumoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("SumoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
