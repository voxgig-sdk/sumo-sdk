...
func NewRankEntity(client *core.SumoSDK, entopts map[string]any) *RankEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RankEntity) GetName() string { return e.name }
...
func (e *RankEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RankEntity) Deleted() bool {
	return e.deleted
}


func (e *RankEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRankEntity(e.client, opts)
}

func (e *RankEntity) Data(args ...any) any {
...
func (e *RankEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rank; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RankEntity) DataTyped(data ...Rank) Rank {
	if len(data) > 0 {
		return typedFrom[Rank](e.Data(asMap(data[0])))
	}
	return typedFrom[Rank](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rank (all fields
// optional at the wire level).
func (e *RankEntity) MatchTyped(match ...Rank) Rank {
	if len(match) > 0 {
		return typedFrom[Rank](e.Match(asMap(match[0])))
	}
	return typedFrom[Rank](e.Match())
}
...
func (e *RankEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RankEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RankEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RankListMatch and returns []Rank. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RankEntity) ListTyped(reqmatch RankListMatch, ctrl map[string]any) ([]Rank, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rank](res), nil
}



func (e *RankEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RankEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RankEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RankEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
