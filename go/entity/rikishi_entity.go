...
func NewRikishiEntity(client *core.SumoSDK, entopts map[string]any) *RikishiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RikishiEntity) GetName() string { return e.name }
...
func (e *RikishiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RikishiEntity) Deleted() bool {
	return e.deleted
}


func (e *RikishiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRikishiEntity(e.client, opts)
}

func (e *RikishiEntity) Data(args ...any) any {
...
func (e *RikishiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Rikishi; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RikishiEntity) DataTyped(data ...Rikishi) Rikishi {
	if len(data) > 0 {
		return typedFrom[Rikishi](e.Data(asMap(data[0])))
	}
	return typedFrom[Rikishi](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Rikishi (all fields
// optional at the wire level).
func (e *RikishiEntity) MatchTyped(match ...Rikishi) Rikishi {
	if len(match) > 0 {
		return typedFrom[Rikishi](e.Match(asMap(match[0])))
	}
	return typedFrom[Rikishi](e.Match())
}
...
func (e *RikishiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RikishiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RikishiLoadMatch and returns an Rikishi. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RikishiEntity) LoadTyped(reqmatch RikishiLoadMatch, ctrl map[string]any) (Rikishi, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Rikishi{}, err
	}
	return typedFrom[Rikishi](res), nil
}




func (e *RikishiEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RikishiListMatch and returns []Rikishi. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RikishiEntity) ListTyped(reqmatch RikishiListMatch, ctrl map[string]any) ([]Rikishi, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Rikishi](res), nil
}



func (e *RikishiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RikishiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RikishiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RikishiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
