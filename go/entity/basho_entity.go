...
func NewBashoEntity(client *core.SumoSDK, entopts map[string]any) *BashoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BashoEntity) GetName() string { return e.name }
...
func (e *BashoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BashoEntity) Deleted() bool {
	return e.deleted
}


func (e *BashoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBashoEntity(e.client, opts)
}

func (e *BashoEntity) Data(args ...any) any {
...
func (e *BashoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Basho; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BashoEntity) DataTyped(data ...Basho) Basho {
	if len(data) > 0 {
		return typedFrom[Basho](e.Data(asMap(data[0])))
	}
	return typedFrom[Basho](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Basho (all fields
// optional at the wire level).
func (e *BashoEntity) MatchTyped(match ...Basho) Basho {
	if len(match) > 0 {
		return typedFrom[Basho](e.Match(asMap(match[0])))
	}
	return typedFrom[Basho](e.Match())
}
...
func (e *BashoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BashoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BashoLoadMatch and returns an Basho. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BashoEntity) LoadTyped(reqmatch BashoLoadMatch, ctrl map[string]any) (Basho, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Basho{}, err
	}
	return typedFrom[Basho](res), nil
}




func (e *BashoEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// BashoListMatch and returns []Basho. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *BashoEntity) ListTyped(reqmatch BashoListMatch, ctrl map[string]any) ([]Basho, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Basho](res), nil
}



func (e *BashoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BashoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BashoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BashoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
