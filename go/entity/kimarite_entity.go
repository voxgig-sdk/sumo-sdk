...
func NewKimariteEntity(client *core.SumoSDK, entopts map[string]any) *KimariteEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KimariteEntity) GetName() string { return e.name }
...
func (e *KimariteEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KimariteEntity) Deleted() bool {
	return e.deleted
}


func (e *KimariteEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKimariteEntity(e.client, opts)
}

func (e *KimariteEntity) Data(args ...any) any {
...
func (e *KimariteEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Kimarite; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KimariteEntity) DataTyped(data ...Kimarite) Kimarite {
	if len(data) > 0 {
		return typedFrom[Kimarite](e.Data(asMap(data[0])))
	}
	return typedFrom[Kimarite](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Kimarite (all fields
// optional at the wire level).
func (e *KimariteEntity) MatchTyped(match ...Kimarite) Kimarite {
	if len(match) > 0 {
		return typedFrom[Kimarite](e.Match(asMap(match[0])))
	}
	return typedFrom[Kimarite](e.Match())
}
...
func (e *KimariteEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KimariteEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KimariteLoadMatch and returns an Kimarite. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *KimariteEntity) LoadTyped(reqmatch KimariteLoadMatch, ctrl map[string]any) (Kimarite, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Kimarite{}, err
	}
	return typedFrom[Kimarite](res), nil
}




func (e *KimariteEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// KimariteListMatch and returns []Kimarite. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *KimariteEntity) ListTyped(reqmatch KimariteListMatch, ctrl map[string]any) ([]Kimarite, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Kimarite](res), nil
}



func (e *KimariteEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *KimariteEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *KimariteEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *KimariteEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
