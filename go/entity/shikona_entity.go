...
func NewShikonaEntity(client *core.SumoSDK, entopts map[string]any) *ShikonaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ShikonaEntity) GetName() string { return e.name }
...
func (e *ShikonaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ShikonaEntity) Deleted() bool {
	return e.deleted
}


func (e *ShikonaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewShikonaEntity(e.client, opts)
}

func (e *ShikonaEntity) Data(args ...any) any {
...
func (e *ShikonaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Shikona; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ShikonaEntity) DataTyped(data ...Shikona) Shikona {
	if len(data) > 0 {
		return typedFrom[Shikona](e.Data(asMap(data[0])))
	}
	return typedFrom[Shikona](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Shikona (all fields
// optional at the wire level).
func (e *ShikonaEntity) MatchTyped(match ...Shikona) Shikona {
	if len(match) > 0 {
		return typedFrom[Shikona](e.Match(asMap(match[0])))
	}
	return typedFrom[Shikona](e.Match())
}
...
func (e *ShikonaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ShikonaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ShikonaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ShikonaListMatch and returns []Shikona. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ShikonaEntity) ListTyped(reqmatch ShikonaListMatch, ctrl map[string]any) ([]Shikona, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Shikona](res), nil
}



func (e *ShikonaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ShikonaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ShikonaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ShikonaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
