...
const testSeed = `map[string]any{"entity": map[string]any{"basho": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "kimarite": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "measurement": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rank": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rikishi": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "shikona": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
