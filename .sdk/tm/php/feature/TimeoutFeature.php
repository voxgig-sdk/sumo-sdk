...
class SumoTimeoutFeature extends SumoBaseFeature
{
    ...
    private function _with_timeout(SumoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(SumoContext $_ctx, float $ms): void
    {
        $client = $this->client;
