...
// Sumo SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class SumoTestFeature extends SumoBaseFeature
{
    ...
    public function init(SumoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (SumoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (SumoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(SumoContext $ctx, $op, $args): array
    {
