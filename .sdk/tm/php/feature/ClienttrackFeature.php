...
class SumoClienttrackFeature extends SumoBaseFeature
{
    ...
    public function PostConstruct(SumoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Sumo-SDK';
