...
class SumoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; SumoSDK/1.0)';
    ...
    public static function call(SumoContext $ctx, string $fullurl, array $fetchdef): array
    {
