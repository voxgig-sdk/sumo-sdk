...
from projectname_sdk.core.control import SumoControl
...
class SumoContext:
    ...
    def make_error(self, code, msg):
        return SumoError(code, msg, self)
