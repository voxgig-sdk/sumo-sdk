...
class SumoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SumoTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = SumoTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = SumoTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
