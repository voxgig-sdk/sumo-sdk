...
class SumoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = SumoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = SumoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = SumoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
