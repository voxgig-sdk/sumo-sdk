...
from projectname_sdk import SumoSDK
from projectname_sdk.core.spec import SumoSpec
from projectname_sdk.core.result import SumoResult
from projectname_sdk.core.response import SumoResponse
from projectname_sdk.core.operation import SumoOperation
from projectname_sdk.core.error import SumoError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import SumoBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = SumoSDK.test(None, None)
        ...
        class TestInitFeature(SumoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(SumoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = SumoSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = SumoSDK.test(None, setup_opts)
