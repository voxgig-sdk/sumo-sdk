...
|---|---|---|
| `ts/` | @voxgig-sdk/sumo-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/sumo-sdk \
      --repository voxgig-sdk/sumo-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/sumo-sdk` shows it, and
`npm trust revoke @voxgig-sdk/sumo-sdk --id=<id>` removes it.
