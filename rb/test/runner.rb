...
module SumoTestRunner
  ...
  def self.env_override(m)
    live = getenv("SUMO_TEST_LIVE")
    override = getenv("SUMO_TEST_OVERRIDE")
    ...
    explain = getenv("SUMO_TEST_EXPLAIN")
    m["SUMO_TEST_EXPLAIN"] = explain if explain && !explain.empty?
