...
class ShikonaEntity
  ...
  def make
    opts = @_entopts.dup
    ShikonaEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [ShikonaListMatch, Hash, nil] match filter (any subset of
  #   Shikona fields); defaults to nil, treated as an empty match that lists all.
