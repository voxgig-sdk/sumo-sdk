...
class MeasurementEntity
  ...
  #
  # @param reqmatch [MeasurementListMatch, Hash, nil] match filter (any subset of
  #   Measurement fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Measurement>, Array] the matching Measurement items; raises SumoError on failure
