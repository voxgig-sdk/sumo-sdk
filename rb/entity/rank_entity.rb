...
class RankEntity
  ...
  #
  # @param reqmatch [RankListMatch, Hash, nil] match filter (any subset of
  #   Rank fields); defaults to nil, treated as an empty match that lists all.
