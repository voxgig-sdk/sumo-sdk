...
from sumo_sdk.utility import register

# Load features
from sumo_sdk.feature.base_feature import SumoBaseFeature
from sumo_sdk.features import _has_feature, _make_feature
...
class SumoSDK:
    ...
    def get_utility(self):
        return SumoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("SumoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Basho(self, data=None) -> "BashoEntity":
        ...
        from sumo_sdk.entity.basho_entity import BashoEntity
    ...
    def Kimarite(self, data=None) -> "KimariteEntity":
        ...
        from sumo_sdk.entity.kimarite_entity import KimariteEntity
    ...
    def Rikishi(self, data=None) -> "RikishiEntity":
        ...
        from sumo_sdk.entity.rikishi_entity import RikishiEntity
    ...
    def Shikona(self, data=None) -> "ShikonaEntity":
        ...
        from sumo_sdk.entity.shikona_entity import ShikonaEntity
