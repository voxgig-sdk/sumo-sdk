# Sumo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions SumoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both SumoSDK(...) and SumoSDK.test(...) become
#      SumoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
