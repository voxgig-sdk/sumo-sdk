...
local KimariteEntity = {}
KimariteEntity.__index = KimariteEntity


function KimariteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, KimariteEntity)
  self._name = "kimarite"
  self._client = client
...
function KimariteEntity:get_name()
  return self._name
end


function KimariteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return KimariteEntity.new(self._client, opts)
end
...
function KimariteEntity:mark_deleted()
  self._deleted = true
end


function KimariteEntity:deleted()
  return true == self._deleted
end


function KimariteEntity:data_set(args)
  if args ~= nil then
...
function KimariteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function KimariteEntity:match_set(args)
  if args ~= nil then
...
function KimariteEntity:match_get()
...
function KimariteEntity:stream(action, args, callopts)
...
---@param reqmatch KimariteLoadMatch
---@param ctrl? table
---@return Kimarite
---@return string? err
function KimariteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch KimariteListMatch
---@param ctrl? table
---@return Kimarite[]
---@return string? err
function KimariteEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function KimariteEntity:_run_op(ctx, post_done)
  local utility = self._utility
