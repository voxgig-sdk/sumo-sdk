...
describe("ShikonaDirect", function()
  it("should direct-list-shikona", function()
    local setup = shikona_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-shikona", setup.live and "live" or "unit")
...
function shikona_direct_setup(mockres)
