...
describe("MeasurementDirect", function()
  it("should direct-list-measurement", function()
    local setup = measurement_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-measurement", setup.live and "live" or "unit")
...
function measurement_direct_setup(mockres)
