...
-- data to return.
local TEST_SEED = '{ entity = { ["basho"] = { ["test01"] = { id = "test01" } }, ["kimarite"] = { ["test01"] = { id = "test01" } }, ["measurement"] = { ["test01"] = { id = "test01" } }, ["rank"] = { ["test01"] = { id = "test01" } }, ["rikishi"] = { ["test01"] = { id = "test01" } }, ["shikona"] = { ["test01"] = { id = "test01" } } } }'
