...
describe("RankDirect", function()
  it("should direct-list-rank", function()
    local setup = rank_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-rank", setup.live and "live" or "unit")
...
function rank_direct_setup(mockres)
