...
// Sumo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (SumoSDK::test)
...
{
    private const SDK_CLASS = 'SumoSDK';
    ...
    private const SDK_BASE = 'sumo_sdk';
