...
class RankDirectTest extends TestCase
{
    public function test_direct_list_rank(): void
    {
        $setup = rank_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-rank", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
