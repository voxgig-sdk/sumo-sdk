...
class SumoTestRunner
{
    ...
    {
        $live = self::getenv('SUMO_TEST_LIVE');
        $override = self::getenv('SUMO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('SUMO_TEST_EXPLAIN');
...
class_alias('SumoTestRunner', 'Runner');
class_alias('SumoHelpers', 'Helpers');
