...
class SumoSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = SumoHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = SumoHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!SumoFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, SumoFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return SumoUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = SumoHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = SumoHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = SumoHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new SumoError($op . "_allow",
                "SumoSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = SumoHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new SumoError("graphql_error",
                "SumoSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Basho($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_basho === null) {
                $this->_basho = new BashoEntity($this, null);
            }
            return $this->_basho;
        }
        return new BashoEntity($this, $data);
    }
    ...
    public function Kimarite($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_kimarite === null) {
                $this->_kimarite = new KimariteEntity($this, null);
            }
            return $this->_kimarite;
        }
        return new KimariteEntity($this, $data);
    }
    ...
    public function Rank($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_rank === null) {
                $this->_rank = new RankEntity($this, null);
            }
            return $this->_rank;
        }
        return new RankEntity($this, $data);
    }
    ...
    public function Rikishi($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_rikishi === null) {
                $this->_rikishi = new RikishiEntity($this, null);
            }
            return $this->_rikishi;
        }
        return new RikishiEntity($this, $data);
    }
    ...
    public function Shikona($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_shikona === null) {
                $this->_shikona = new ShikonaEntity($this, null);
            }
            return $this->_shikona;
        }
        return new ShikonaEntity($this, $data);
    }
