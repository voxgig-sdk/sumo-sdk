...
// Sumo SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class SumoMakeRequest
{
    public static function call(SumoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new SumoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new SumoResponse($fetched);
        } else {
