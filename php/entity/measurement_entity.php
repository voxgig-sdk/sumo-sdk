...
class MeasurementEntity
{
    ...
    /**
     * List Measurement items matching the given filter.
     *
     * @param MeasurementListMatch|array|null $reqmatch Match filter (any subset
     *   of Measurement fields) as an assoc-array; MeasurementListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Measurement[]|array A list of Measurement items as assoc-arrays at
