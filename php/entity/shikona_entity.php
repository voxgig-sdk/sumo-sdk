...
class ShikonaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ShikonaEntity($this->_client, $opts);
    }

    /**
     * @param Shikona|array $args Shikona data (assoc-array) to store.
     */
    ...
    /**
     * @return Shikona|array The current Shikona data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Shikona fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Shikona fields).
     */
     ...
     *
     * @param ShikonaListMatch|array|null $reqmatch Match filter (any subset
     *   of Shikona fields) as an assoc-array; ShikonaListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Shikona[]|array A list of Shikona items as assoc-arrays at
