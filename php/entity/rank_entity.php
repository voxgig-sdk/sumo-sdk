...
class RankEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RankEntity($this->_client, $opts);
    }

    /**
     * @param Rank|array $args Rank data (assoc-array) to store.
     */
    ...
    /**
     * @return Rank|array The current Rank data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rank fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rank fields).
     */
     ...
     *
     * @param RankListMatch|array|null $reqmatch Match filter (any subset
     *   of Rank fields) as an assoc-array; RankListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rank[]|array A list of Rank items as assoc-arrays at
