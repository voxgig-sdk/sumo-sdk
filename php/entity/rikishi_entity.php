...
class RikishiEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RikishiEntity($this->_client, $opts);
    }

    /**
     * @param Rikishi|array $args Rikishi data (assoc-array) to store.
     */
    ...
    /**
     * @return Rikishi|array The current Rikishi data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Rikishi fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Rikishi fields).
     */
     ...
     *
     * @param RikishiLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RikishiLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rikishi|array The loaded Rikishi as an assoc-array at the
     ...
     *
     * @param RikishiListMatch|array|null $reqmatch Match filter (any subset
     *   of Rikishi fields) as an assoc-array; RikishiListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Rikishi[]|array A list of Rikishi items as assoc-arrays at
