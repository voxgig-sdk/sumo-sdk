...
class SumoNetsimFeature extends SumoBaseFeature
{
    ...
    private function _simulate(SumoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(SumoContext $ctx, array $applied): void
    {
        $client = $this->client;
