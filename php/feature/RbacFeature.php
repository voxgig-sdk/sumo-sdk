...
class SumoRbacFeature extends SumoBaseFeature
{
    ...
    private function _required(SumoContext $ctx): ?string
    {
    ...
    private function _reject(SumoContext $ctx, string $required): void
    {
    ...
    private function _track(SumoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
