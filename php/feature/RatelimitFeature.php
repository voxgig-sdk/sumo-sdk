...
class SumoRatelimitFeature extends SumoBaseFeature
{
    ...
    private function _acquire(SumoContext $ctx): void
    {
    ...
    private function _track(SumoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
