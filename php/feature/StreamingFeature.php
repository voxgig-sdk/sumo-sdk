...
class SumoStreamingFeature extends SumoBaseFeature
{
    ...
    private function _iterate(SumoResult $result): \Generator
    {
    ...
    private function _streamable(SumoContext $ctx): bool
    {
