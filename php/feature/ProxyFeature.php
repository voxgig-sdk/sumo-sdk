...
class SumoProxyFeature extends SumoBaseFeature
{
    ...
    public function init(SumoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (SumoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
