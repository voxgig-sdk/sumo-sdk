...
class SumoCacheFeature extends SumoBaseFeature
{
    ...
    private function _through(SumoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
